...
import { deleteChat, generateAi, getAllChats, getChatById, getChatByUserId, updateChat } from "../controllers/chat.controller";
...
router.post("/generate/ai",protectRoute([RoleEnum[0], RoleEnum[1]]),blockIfDisabled, generateAi);
